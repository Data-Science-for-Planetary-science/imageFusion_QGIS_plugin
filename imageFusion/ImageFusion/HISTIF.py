...
if __name__ == "__main__":
    ...
    fusion_test = HISTIF("Tests/test-1/coarse_t0.tif", "Tests/test-1/coarse_t1.tif", "Tests/test-1/fine_t0.tif", file_type = "tiff")
    ...
    standard_writer = DataWriter(standard_predicted, f"Predictions/HISTIF_pred.tiff").store_geotiff_file()
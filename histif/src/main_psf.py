...
from . import global_vars  as global_vars
from .FFT import FFT
...
def main_psf(coarse_img_t0=None, fine_img_t0=None, coarse_img_t1=None, params=None, iter=200, flag=0, neighbors=4, old_version=False):
    ...
    if(flag == 0):
        ...
        print('Shape of fine and coarse images : ',fine1.shape,coarse2.shape)
    elif(flag == 1):
        fine1 = fine_img_t0
        coarse1 = coarse_img_t0
        coarse2 = coarse_img_t1

        # print(fine1.shape, coarse1.shape, coarse2.shape)
    ...
    for global_vars.iband in range(limits):
        ...
        # print('LR1',global_vars.LR1,global_vars.LR1.shape)
    ...
    # return global_vars.pre_image, np.array(channel_image),fine1Points
